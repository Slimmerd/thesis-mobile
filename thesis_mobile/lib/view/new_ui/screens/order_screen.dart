...
import 'package:thesis_mobile/view/new_ui/popups/order_review_popup.dart';
...
import 'package:thesis_mobile/view/new_ui/widgets/order/order_product_card.dart';
...
class OrderScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    taskContext.addLogTask('[NEWUI][OPENED] OrderScreen ${order.id}');
